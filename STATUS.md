...
| §5.7 v2 asset root, self-custody writes, bulk stream, purge/GC | **Not implemented** | Fields and authority slots are reserved; callers fail closed rather than silently falling back to v1 behavior. |
